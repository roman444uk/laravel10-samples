...
$(document).ready(function ($) {
	...
	// Datatable
	if ($('.datatable').length > 0 && window.DataTable) {
		$('.datatable').DataTable({
			"bFilter": false,
		});
	}
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.toggle-password').forEach((togglePasswordElement) => {
        let inputElement = togglePasswordElement.previousElementSibling;
